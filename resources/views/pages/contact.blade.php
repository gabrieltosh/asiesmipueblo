...
@section('content')
    <div class="bg-black context-dark parallax-container" data-parallax-img="images/intros/intro-03-1920x955.jpg">
            ...
            <div class="container">
                <div
                    ...
                    <div class="col-lg-12 col-xl-10 col-xxl-6">
                        <div class="row">
                            <div class="col-lg-6 col-xxl-12 text-lg-left text-xxl-center">
                            ...
                            <div class="col-lg-6 col-xxl-12 offset-md-top-66">
