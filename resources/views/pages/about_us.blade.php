    ...
    <section class="section novi-background section-98 section-sm-110">
        <div class="container">
          ...
          <div class="row justify-content-sm-center text-center text-lg-left offset-top-66">
            <div class="col-md-5 col-lg-3"><img style="border-radius:12px !important;" class="img-fluid d-inline-block" src="{{asset('assets/images/about_us_profile_1.jpeg')}}" width="270" height="270" alt="">
          ...
          <div class="row justify-content-sm-center text-center text-lg-left offset-top-66">
            <div class="col-md-5 col-lg-3 offset-top-50 offset-md-top-0"><img style="border-radius:12px !important;" class="img-fluid d-inline-block" src="{{asset('assets/images/about_us_profile_2.jpeg')}}" width="270" height="270" alt="">
              <div class="text-lg-left offset-top-20">
                <div>
            ...
            <div class="col-md-5 col-lg-3 offset-top-50 offset-lg-top-0"><img style="border-radius:12px !important;" class="img-fluid d-inline-block" src="{{asset('assets/images/about_us_profile_3f.jpeg')}}" width="270" height="270" alt="">
              <div class="text-lg-left offset-top-20">
                <div>
            ...
            <div class="col-md-5 col-lg-3 offset-top-50 offset-lg-top-0"><img style="border-radius:12px !important;" class="img-fluid d-inline-block" src="{{asset('assets/images/about_us_profile_4.jpeg')}}" width="270" height="270" alt="">
              <div class="text-lg-left offset-top-20">
                <div>
            ...
            <div class="col-md-5 col-lg-3 offset-top-50 offset-lg-top-0"><img style="border-radius:12px !important;" class="img-fluid d-inline-block" src="{{asset('assets/images/about_us_profile_5f.jpeg')}}" width="270" height="270" alt="">
              <div class="text-lg-left offset-top-20">
                <div>
            ...
            <div class="col-md-5 col-lg-3 offset-top-50 "><img style="border-radius:12px !important;" class="img-fluid d-inline-block" src="{{asset('assets/images/about_us_profile_6.jpeg')}}" width="270" height="270" alt="">
              <div class="text-lg-left offset-top-20">
                <div>
            ...
            <div class="col-md-5 col-lg-3 offset-top-50 "><img style="border-radius:12px !important;" class="img-fluid d-inline-block" src="{{asset('assets/images/about_us_profile_7.jpeg')}}" width="270" height="270" alt="">
                <div class="text-lg-left offset-top-20">
                  <div>
