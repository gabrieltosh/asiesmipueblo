...
<html class="wide wow-animation scrollTo" lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../intense-child-care/css/style.css">
    <style>.ie-panel{display: none;background: #212121;padding: 10px 0;box-shadow: 3px 3px 5px 0 rgba(0,0,0,.3);clear: both;text-align:center;position: relative;z-index: 1;} html.ie-10 .ie-panel, html.lt-ie-10 .ie-panel {display: block;}</style>
  </head>
  <body>
    <div class="page-loader page-loader-variant-1">
      <div><img class="img-fluid" width="329" height="67" src="images/childs/child-care-logo-big-330x67.png" alt=""/>
    ...
    <div class="page text-center">
          ...
          <nav class="rd-navbar rd-navbar-top-panel rd-navbar-light" data-lg-stick-up-offset="79px" data-md-device-layout="rd-navbar-fixed" data-lg-device-layout="rd-navbar-static" data-lg-auto-height="true" data-md-layout="rd-navbar-fixed" data-lg-layout="rd-navbar-static" data-lg-stick-up="true">
            <div class="rd-navbar-inner">
              <div class="rd-navbar-top-panel">
                <div class="container">
                  <div class="left-side">
                    <address class="contact-info text-left"><span class="p"><span class="icon novi-icon mdi mdi-phone text-primary"></span><a href="tel:#">1-800-1234-567</a></span><span class="p"><span class="icon novi-icon mdi mdi-map-marker-radius text-primary"></span><a href="contact-us.html">2130 Fulton Street, San Francisco, CA 94117-1080 USA</a></span></address>
                  </div>
                  <div class="right-side offset-top-4 offset-xl-top-0 text-center">
                    <div class="contact-info text-left d-inline-block"><span class="p"><span class="icon novi-icon mdi mdi-clock text-primary"></span><span>Mon–Sat: 7:00am–8:00pm</span></span></div>
                    <ul class="list-inline list-inline-xs d-inline-block inset-xl-left-80">
                      <li class="list-inline-item"><a href="#"><span class="icon novi-icon fa-facebook"></span></a></li>
                      <li class="list-inline-item"><a href="#"><span class="icon novi-icon fa-twitter"></span></a></li>
                      <li class="list-inline-item"><a href="#"><span class="icon novi-icon fa-google-plus"></span></a></li>
                      <li class="list-inline-item"><a href="#"><span class="icon novi-icon fa-youtube-play"></span></a></li>
                      <li class="list-inline-item"><a href="#"><span class="icon novi-icon fa-instagram"></span></a></li>
                    </ul>
                  </div>
                </div>
              </div>
              <div class="container section-relative d-flex justify-content-between">
                ...
                <div class="rd-navbar-panel">
                  ...
                  <!--Navbar Brand-->
                  <div class="rd-navbar-brand"><a class="d-none d-xl-block" href="index.html"><img class="img-fluid" width="135" height="55" src="images/childs/intense-child-care-logo-dark.png" alt=""/></a><a class="d-xl-none" href="index.html"><img class="img-fluid" width="243" height="32" src="images/childs/intense-child-care-logo-dark-horizontal.png" alt=""/></a></div>
                </div>
                <div class="rd-navbar-menu-wrap">
                  <div class="rd-navbar-nav-wrap">
                    <div class="rd-navbar-mobile-scroll">
                      <!--Navbar Brand Mobile-->
                      <div class="rd-navbar-mobile-brand"><a class="d-inline-block" href="index.html"><img class="img-fluid" width="135" height="55" src="images/childs/intense-child-care-logo-dark.png" alt=""/></a></div>
                      ...
                      <ul class="rd-navbar-nav">
                        <li class="active"><a href="index.html"><span>Home</span><span class="rd-navbar-label text-middle label-custom label-danger label-xs-custom label-rounded-custom label">[object Object]</span></a>
      ...
      <!-- Intense is the most-->
      <section class="section-66 section-sm-85 section-md-bottom-124">
        <div class="container">
          <div class="row justify-content-sm-center offset-lg-top-41">
            <div class="col-sm-10 col-lg-6 offset-md-top-10 order-lg-2">
              <!-- Media Elements-->
              <div class="embed-responsive embed-responsive-16by9">
                <iframe class="embed-responsive-item" src="//www.youtube.com/embed/-AhmuMqZB0s?wmode=transparent"></iframe>
              </div>
            </div>
            <div class="col-sm-10 col-lg-6 order-lg-1 offset-top-50 offset-lg-top-0">
              <div class="text-md-left inset-md-right-30">
                <h1 class="font-weight-bold text-uppercase text-primary">Intense is the most flexible Bootstrap theme on TemplateMonster</h1>
                <div class="offset-top-20 offset-lg-top-50">
                  <p>Join the 205,000+ Satified Customers Today at TemplateMonster.com. Created by the industry leaders Intense is a comprehensive set of tools which are super easy to pick up and run. It gives you a huge leg up to create your own beautiful site. Powerful options & tools, unlimited designs, responsive framework and amazing support are the reasons for our customers to fall in love.</p>
                </div>
                <div class="offset-top-30 offset-lg-top-30"><a class="btn btn-safety-orange" href="contact-us.html">contact us</a></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section class="section-98 section-md-124 bg-lightest">
        <div class="container">
          <h1 class="text-primary font-weight-bold">Take Full Control of Your Site</h1>
          <svg height="13" viewbox="0 0 71 13" width="71" xmlns="http://www.w3.org/2000/svg" version="1.1">
          ...
          <div class="row text-lg-left offset-top-50">
            <div class="col-md-8 offset-md-2 col-lg-4 offset-lg-0">
              <!-- Icon Box Type 2-->
              <div class="unit unit-sm flex-md-row text-md-left">
                <div class="unit-left"><span class="icon novi-icon icon-lg icon-circle icon-bordered text-safety-orange mdi mdi-brush"></span></div>
                <div class="unit-body">
                  <h4 class="font-weight-bold font-default text-uppercaase offset-lg-top-20">ADVANCED UI KIT</h4>
                  <p>Intense has dozens of new components and elements built on the same level of quality as Bootstrap elements and highlighted with several example pages.</p>
                </div>
              </div>
            </div>
            <div class="col-md-8 offset-md-2 col-lg-4 offset-lg-0 offset-top-66 offset-lg-top-0">
              <!-- Icon Box Type 2-->
              <div class="unit unit-sm flex-md-row text-md-left">
                <div class="unit-left"><span class="icon novi-icon icon-lg icon-circle icon-bordered text-safety-orange mdi mdi-cube-outline"></span></div>
                <div class="unit-body">
                  <h4 class="font-weight-bold font-default text-uppercaase offset-lg-top-20">EXTENDED TOOLKIT</h4>
                  <p>Intense provides a poweful and flexible exntended toolkit in addition to basic Bootsrap. If you’ve used Bootstrap itself, you’ll find this all super familiar and easy-to-use.</p>
                </div>
              </div>
            </div>
            <div class="col-md-8 offset-md-2 col-lg-4 offset-lg-0 offset-top-66 offset-lg-top-0">
              <!-- Icon Box Type 2-->
              <div class="unit unit-sm flex-md-row text-md-left">
                <div class="unit-left"><span class="icon novi-icon icon-lg icon-circle icon-bordered text-safety-orange mdi mdi-palette"></span></div>
                <div class="unit-body">
                  <h4 class="font-weight-bold font-default text-uppercaase offset-lg-top-20">UNLIMITED SKINS &amp; COLORS</h4>
                  <p>Theme components inherit much of their style from variables, exactly like Bootstrap. Change a few values and the theme adapts.</p>
                </div>
              </div>
            </div>
            <div class="col-md-8 offset-md-2 col-lg-4 offset-lg-0 offset-top-66">
              <!-- Icon Box Type 2-->
              <div class="unit unit-sm flex-md-row text-md-left">
                <div class="unit-left"><span class="icon novi-icon icon-lg icon-circle icon-bordered text-safety-orange mdi mdi-vector-arrange-above"></span></div>
                <div class="unit-body">
                  <h4 class="font-weight-bold font-default text-uppercaase offset-lg-top-20">PARALLAX EFFECTS</h4>
                  <p>Everyone loves parallax scrolling effects, they are simply beautiful. Intense has advanced parallax options &amp; controls based on flexible and easy-to-use RD Parallax plugin.</p>
                </div>
              </div>
            </div>
            <div class="col-md-8 offset-md-2 col-lg-4 offset-lg-0 offset-top-66">
              <!-- Icon Box Type 2-->
              <div class="unit unit-sm flex-md-row text-md-left">
                <div class="unit-left"><span class="icon novi-icon icon-lg icon-circle icon-bordered text-safety-orange mdi mdi-share-variant"></span></div>
                <div class="unit-body">
                  <h4 class="font-weight-bold font-default text-uppercaase offset-lg-top-20">SOCIAL INTEGRATION</h4>
                  <p>Intense has full set of social icons and styling options which allow you to share any content the way you wish.</p>
                </div>
              </div>
            </div>
            <div class="col-md-8 offset-md-2 col-lg-4 offset-lg-0 offset-top-66">
              <!-- Icon Box Type 2-->
              <div class="unit unit-sm flex-md-row text-md-left">
                <div class="unit-left"><span class="icon novi-icon icon-lg icon-circle icon-bordered text-safety-orange mdi mdi-spellcheck"></span></div>
                <div class="unit-body">
                  <h4 class="font-weight-bold font-default text-uppercaase offset-lg-top-20">MADE FOR SPEED</h4>
                  <p>We know how embarassing and time-consuming can be content loading, so we took care of pages optimization for your smooth expirience.</p>
                </div>
              </div>
            </div>
          </div>
          <div class="offset-top-50"><a class="btn btn-primary" href="//documentation.zemez.io/html/bootstrap/intense/" target="_blank">buy intense now</a></div>
        </div>
      </section>
      <!-- Counters-->
      <section class="section parallax-container" data-parallax-img="images/skins/skin-eternal-joy-02-1920x748.jpg">
        <div class="parallax-content section-98 context-dark">
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-6 col-lg-3 offset-lg-0">
                <!-- Counter type 1-->
                <div class="counter-type-1">
                  <div class="h2"><span class="big counter font-weight-bold font-default" data-step="3000" data-from="0" data-to="58249">0</span>
                    <hr class="divider bg-gray-darker">
                  </div>
                  <h6 class="text-uppercase text-spacing-60 font-default">Templates</h6>
                </div>
              </div>
              <div class="col-md-6 col-lg-3 offset-top-66 offset-md-top-0">
                <!-- Counter type 1-->
                <div class="counter-type-1">
                  <div class="h2"><span class="big counter font-weight-bold font-default" data-speed="2500" data-from="0" data-to="246">0</span><span class="big font-weight-bold font-default">K</span>
                    <hr class="divider bg-gray-darker">
                  </div>
                  <h6 class="text-uppercase text-spacing-60 font-default">Happy Clients</h6>
                </div>
              </div>
              <div class="col-md-6 col-lg-3 offset-top-66 offset-lg-top-0">
                <!-- Counter type 1-->
                <div class="counter-type-1">
                  <div class="h2"><span class="big counter font-weight-bold font-default" data-step="1500" data-from="0" data-to="1200">0</span>
                    <hr class="divider bg-gray-darker">
                  </div>
                  <h6 class="text-uppercase text-spacing-60 font-default">Hours of Coding</h6>
                </div>
              </div>
              <div class="col-md-6 col-lg-3 offset-top-66 offset-lg-top-0">
                <!-- Counter type 1-->
                <div class="counter-type-1">
                  <div class="h2"><span class="big counter font-weight-bold font-default" data-speed="1300" data-from="0" data-to="834">0</span><span class="big font-weight-bold font-default">K</span>
                    <hr class="divider bg-gray-darker">
                  </div>
                  <h6 class="text-uppercase text-spacing-60 font-default">Lines of Code</h6>
                </div>
              </div>
            </div>
          </div>
      ...
      <section class="section-98 section-md-124">
        <div class="container">
          <h1 class="text-primary font-weight-bold">Our Advantages</h1>
          <svg height="13" viewbox="0 0 71 13" width="71" xmlns="http://www.w3.org/2000/svg" version="1.1">
            <path class="bg-primary" d="M 65.591797,0.39453125 C 64.632414,0.55512546 63.656631,1.037019 62.839844,1.9121094 l 2.009765,1.875 c 0.987119,-1.0575807 1.464926,-0.9055776 2.074219,-0.5703125 0.609293,0.335265 1.125342,1.2616345 1.144531,1.6152343 C 68.111503,5.6270437 67.786283,6.2015228 66.951172,6.875 66.116061,7.5484772 64.791442,8.161997 63.316406,8.6230469 60.366335,9.5451467 56.822431,9.9000923 55.357422,9.9453125 49.487597,10.126495 41.515727,8.2106051 34.380859,5.9648438 30.873861,4.8609863 26.209294,2.9728751 21.335938,1.7480469 16.462581,0.52321864 11.317182,-0.07967759 6.7734375,1.6503906 l -0.025391,0.00977 -0.025391,0.00977 C 4.3944177,2.6636873 2.6199428,4.0438286 1.515625,5.5957031 0.41130724,7.1475776 -0.0588551,9.0257429 0.7265625,10.642578 c 0.735964,1.515031 2.2978692,2.250647 3.6972656,2.234375 1.3993964,-0.01627 2.7415813,-0.606444 3.6738281,-1.679687 L 6.0214844,9.3945312 C 5.6678168,9.8016889 4.967102,10.122226 4.3925781,10.128906 3.8180543,10.135587 3.4724885,10.00395 3.1992188,9.4414062 2.9754025,8.9806654 3.024638,8.2170231 3.7558594,7.1894531 4.4839472,6.1662866 5.8567444,5.037042 7.78125,4.2109375 c 3.674744,-1.3881932 8.271853,-0.9562457 12.884766,0.203125 4.624565,1.1622992 9.200779,3.012418 12.890625,4.1738281 7.258822,2.2847774 15.360414,4.3068544 21.884765,4.1054684 1.739141,-0.05368 5.355814,-0.40149 8.695313,-1.445312 1.669749,-0.521911 3.270286,-1.207639 4.541015,-2.232422 C 69.948464,7.990842 70.909328,6.4678364 70.8125,4.6835938 70.724917,3.0697107 69.754257,1.63739 68.248047,0.80859375 67.494942,0.39419565 66.55118,0.23393704 65.591797,0.39453125 Z"></path>
          </svg>
          <div class="row align-items-center justify-content-center offset-top-98 grid-group-sm">
            <div class="col-lg-4 order-lg-1"><img class="img-fluid d-block mx-auto" src="images/moqups/moqup-home-mobile.png" alt="" width="247" height="470"></div>
            <div class="col-md-8 col-lg-4 text-lg-right">
              <div class="unit unit-spacing-sm unit-md flex-lg-row-reverse">
                <div class="unit-left"><span class="icon icon-circle novi-icon icon-lg icon-bordered text-safety-orange mdi mdi-message-text-outline"></span></div>
                <div class="unit-body">
                  <h4 class="offset-lg-top-24 font-default text-uppercase font-weight-bold">Social Integration</h4>
                  <p>The information should be not only well-organized and easy to read. thus making the process enjoyable.</p>
                </div>
              </div>
              <div class="unit unit-spacing-sm unit-md flex-lg-row-reverse offset-top-30">
                <div class="unit-left"><span class="icon icon-circle novi-icon icon-lg icon-bordered text-safety-orange mdi mdi-image-filter"></span></div>
                <div class="unit-body">
                  <h4 class="offset-lg-top-24 font-default text-uppercase font-weight-bold">All images Included</h4>
                  <p>The information should be not only well-organized and easy to read. thus making the process enjoyable.</p>
                </div>
              </div>
              <div class="unit unit-spacing-sm unit-md flex-lg-row-reverse offset-top-30">
                <div class="unit-left"><span class="icon icon-circle novi-icon icon-lg icon-bordered text-safety-orange mdi mdi-emoticon-happy"></span></div>
                <div class="unit-body">
                  <h4 class="offset-lg-top-24 font-default text-uppercase font-weight-bold">2000+ <br class="d-none d-md-inline d-lg-none"> icons</h4>
                  <p>The information should be not only well-organized and easy to read. thus making the process enjoyable.</p>
                </div>
              </div>
            </div>
            <div class="col-md-8 col-lg-4 order-lg-1 text-lg-left">
              <div class="unit unit-spacing-sm unit-md flex-lg-row">
                <div class="unit-left"><span class="icon icon-circle novi-icon icon-lg icon-bordered text-safety-orange mdi mdi-cellphone-link"></span></div>
                <div class="unit-body">
                  <h4 class="offset-lg-top-24 font-default text-uppercase font-weight-bold">Responsive & Retina</h4>
                  <p>The information should be not only well-organized and easy to read. thus making the process enjoyable.</p>
                </div>
              </div>
              <div class="unit unit-spacing-sm unit-md flex-lg-row offset-top-30">
                <div class="unit-left"><span class="icon icon-circle novi-icon icon-lg icon-bordered text-safety-orange mdi mdi-television-guide"></span></div>
                <div class="unit-body">
                  <h4 class="offset-lg-top-24 font-default text-uppercase font-weight-bold">Extensive docs</h4>
                  <p>The information should be not only well-organized and easy to read. thus making the process enjoyable.</p>
                </div>
              </div>
              <div class="unit unit-spacing-sm unit-md flex-lg-row offset-top-30">
                <div class="unit-left"><span class="icon icon-circle novi-icon icon-lg icon-bordered text-safety-orange mdi mdi-play-box-outline"></span></div>
                <div class="unit-body">
                  <h4 class="offset-lg-top-24 font-default text-uppercase font-weight-bold">Video backgrounds</h4>
                  <p>The information should be not only well-organized and easy to read. thus making the process enjoyable.</p>
                </div>
              </div>
            </div>
            ...
            <div class="row justify-content-sm-center">
              <div class="col-sm-8">
                <div class="row align-items-md-center">
                  <div class="col-xl-8">
                    <h2 class="font-weight-bold"><span class="big">Intense Is Exactly What You Need</span></h2>
                  </div>
                  <div class="col-xl-4"><a class="btn btn-safety-orange" href="//documentation.zemez.io/html/bootstrap/intense/" target="_blank">buy intense now</a></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section class="section-98 section-md-124">
        <div class="container-fluid">
          <h1 class="font-weight-bold text-uppercase text-primary">Child Themes</h1>
          <svg height="13" viewbox="0 0 71 13" width="71" xmlns="http://www.w3.org/2000/svg" version="1.1">
            <path class="bg-primary" d="M 65.591797,0.39453125 C 64.632414,0.55512546 63.656631,1.037019 62.839844,1.9121094 l 2.009765,1.875 c 0.987119,-1.0575807 1.464926,-0.9055776 2.074219,-0.5703125 0.609293,0.335265 1.125342,1.2616345 1.144531,1.6152343 C 68.111503,5.6270437 67.786283,6.2015228 66.951172,6.875 66.116061,7.5484772 64.791442,8.161997 63.316406,8.6230469 60.366335,9.5451467 56.822431,9.9000923 55.357422,9.9453125 49.487597,10.126495 41.515727,8.2106051 34.380859,5.9648438 30.873861,4.8609863 26.209294,2.9728751 21.335938,1.7480469 16.462581,0.52321864 11.317182,-0.07967759 6.7734375,1.6503906 l -0.025391,0.00977 -0.025391,0.00977 C 4.3944177,2.6636873 2.6199428,4.0438286 1.515625,5.5957031 0.41130724,7.1475776 -0.0588551,9.0257429 0.7265625,10.642578 c 0.735964,1.515031 2.2978692,2.250647 3.6972656,2.234375 1.3993964,-0.01627 2.7415813,-0.606444 3.6738281,-1.679687 L 6.0214844,9.3945312 C 5.6678168,9.8016889 4.967102,10.122226 4.3925781,10.128906 3.8180543,10.135587 3.4724885,10.00395 3.1992188,9.4414062 2.9754025,8.9806654 3.024638,8.2170231 3.7558594,7.1894531 4.4839472,6.1662866 5.8567444,5.037042 7.78125,4.2109375 c 3.674744,-1.3881932 8.271853,-0.9562457 12.884766,0.203125 4.624565,1.1622992 9.200779,3.012418 12.890625,4.1738281 7.258822,2.2847774 15.360414,4.3068544 21.884765,4.1054684 1.739141,-0.05368 5.355814,-0.40149 8.695313,-1.445312 1.669749,-0.521911 3.270286,-1.207639 4.541015,-2.232422 C 69.948464,7.990842 70.909328,6.4678364 70.8125,4.6835938 70.724917,3.0697107 69.754257,1.63739 68.248047,0.80859375 67.494942,0.39419565 66.55118,0.23393704 65.591797,0.39453125 Z"></path>
          </svg>
          <div class="row justify-content-sm-center">
            <div class="col-sm-10">
              <p>Check out other themes based on INTENSE</p>
            </div>
          </div>
                    ...
                    <ul class="list-inline list-inline-sm">
                      ...
                      <li class="list-inline-item section-relative">
                        ...
                        <ul class="list-sm-inline isotope-filters-list" id="isotope-1">
                          ...
                          <li class="list-inline-item"><a class="font-weight-bold" data-isotope-filter="Infrastructure" data-isotope-group="gallery" href="#">Infrastructure</a></li>
                          <li class="list-inline-item"><a class="font-weight-bold" data-isotope-filter="Portfolio" data-isotope-group="gallery" href="#">Portfolio</a></li>
                          <li class="list-inline-item"><a class="font-weight-bold" data-isotope-filter="Blog" data-isotope-group="gallery" href="#">Blog</a></li>
                          <li class="list-inline-item"><a class="font-weight-bold" data-isotope-filter="Agency" data-isotope-group="gallery" href="#">Agency</a></li>
                          <li class="list-inline-item"><a class="font-weight-bold" data-isotope-filter="Creative" data-isotope-group="gallery" href="#">Creative</a></li>
                        </ul>
                      </li>
                    </ul>
                  </div>
                ...
                <div class="col-xl-12 offset-top-34">
                  <div class="isotope" data-isotope-layout="fitRows" data-isotope-group="gallery">
                    ...
                    <div class="row grid-group-sm">
                      <div class="col-12 col-md-6 col-xl-4 isotope-item" data-filter="Agency">
                        <div class="shadow-variant-2"><a class="thumbnail-classic" href="../intense-job-board/index.html" target="_blank">
                            <figure><img width="570" height="428" src="images/childs/intense-job-board-570x428.jpg" alt="">
                              <figcaption class="thumbnail-classic-caption text-center">
                                <h4 class="thumbnail-classic-title text-uppercase text-darkest">Intense Job Board</h4>
                                <p class="thumbnail-classic-desc text-bold text-uppercase veil reveal-xs-block">Best for employment services</p>
                              </figcaption>
                            </figure></a>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 col-xl-4 isotope-item" data-filter="Infrastructure">
                        <div class="shadow-variant-2"><a class="thumbnail-classic" href="../intense-child-care/index.html" target="_blank">
                            <figure><img width="570" height="428" src="images/childs/intense-child-care-570x428.jpg" alt="">
                              <figcaption class="thumbnail-classic-caption text-center">
                                <h4 class="thumbnail-classic-title text-uppercase text-darkest">Intense Child Care</h4>
                      ...
                      <div class="col-12 col-md-6 col-xl-4 isotope-item" data-filter="Agency">
                        <div class="shadow-variant-2"><a class="thumbnail-classic" href="../intense-financial-analytic/index.html" target="_blank">
                            <figure><img width="570" height="428" src="images/childs/intense-financial-advisor-570x428.jpg" alt="">
                              <figcaption class="thumbnail-classic-caption text-center">
                                <h4 class="thumbnail-classic-title text-uppercase text-darkest">Intense Financial Advisor</h4>
                      ...
                      <div class="col-12 col-md-6 col-xl-4 isotope-item" data-filter="Agency">
                        <div class="shadow-variant-2"><a class="thumbnail-classic" href="../intense-gym/index.html" target="_blank">
                            <figure><img width="570" height="428" src="images/childs/intense-gym-570x428.jpg" alt="">
                              <figcaption class="thumbnail-classic-caption text-center">
                                <h4 class="thumbnail-classic-title text-uppercase text-darkest">Intense Gym</h4>
                      ...
                      <div class="col-12 col-md-6 col-xl-4 isotope-item" data-filter="Infrastructure">
                        <div class="shadow-variant-2"><a class="thumbnail-classic" href="../intense-dental-clinic/index.html" target="_blank">
                            <figure><img width="570" height="428" src="images/childs/intense-dental-clinic-570x428.jpg" alt="">
                              <figcaption class="thumbnail-classic-caption text-center">
                                <h4 class="thumbnail-classic-title text-uppercase text-darkest">Intense Dental Clinic</h4>
                                <p class="thumbnail-classic-desc text-bold text-uppercase veil reveal-xs-block">Best for professional dentists</p>
                              </figcaption>
                            </figure></a>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 col-xl-4 isotope-item" data-filter="Creative">
                        <div class="shadow-variant-2"><a class="thumbnail-classic" href="../intense-handmade/index.html" target="_blank">
                            <figure><img width="570" height="428" src="images/childs/intense-handmade-570x428.jpg" alt="">
                              <figcaption class="thumbnail-classic-caption text-center">
                                <h4 class="thumbnail-classic-title text-uppercase text-darkest">Intense Handmade</h4>
                      ...
                      <div class="col-12 col-md-6 col-xl-4 isotope-item" data-filter="Agency">
                        <div class="shadow-variant-2"><a class="thumbnail-classic" href="../intense-real-estate/index.html" target="_blank">
                            <figure><img width="570" height="428" src="images/childs/intense-real-estate-570x428.jpg" alt="">
                              <figcaption class="thumbnail-classic-caption text-center">
                                <h4 class="thumbnail-classic-title text-uppercase text-darkest">Intense Real Estate</h4>
                                <p class="thumbnail-classic-desc text-bold text-uppercase veil reveal-xs-block">Best for property agencies</p>
                              </figcaption>
                            </figure></a>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 col-xl-4 isotope-item" data-filter="Blog">
                        <div class="shadow-variant-2"><a class="thumbnail-classic" href="../intense-personal-blog/index.html" target="_blank">
                            <figure><img width="570" height="428" src="images/childs/intense-personal-blog-570x428.jpg" alt="">
                              <figcaption class="thumbnail-classic-caption text-center">
                                <h4 class="thumbnail-classic-title text-uppercase text-darkest">Intense Personal Blog</h4>
                                <p class="thumbnail-classic-desc text-bold text-uppercase veil reveal-xs-block">Best for individual bloggers</p>
                              </figcaption>
                            </figure></a>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 col-xl-4 isotope-item" data-filter="Portfolio">
                        <div class="shadow-variant-2"><a class="thumbnail-classic" href="../intense-photographer-portfolio/index.html" target="_blank">
                            <figure><img width="570" height="428" src="images/childs/intense-photographer-570x428.jpg" alt="">
                              <figcaption class="thumbnail-classic-caption text-center">
                                <h4 class="thumbnail-classic-title text-uppercase text-darkest">Intense Photographer</h4>
                      ...
                      <div class="col-12 col-md-6 col-xl-4 isotope-item" data-filter="Infrastructure">
                        <div class="shadow-variant-2"><a class="thumbnail-classic" href="../intense-restaurant/index.html" target="_blank">
                            <figure><img width="570" height="428" src="images/childs/intense-restaurant-570x428.jpg" alt="">
                              <figcaption class="thumbnail-classic-caption text-center">
                                <h4 class="thumbnail-classic-title text-uppercase text-darkest">Intense Restaurant</h4>
                      ...
                      <div class="col-12 col-md-6 col-xl-4 isotope-item" data-filter="Creative">
                        <div class="shadow-variant-2"><a class="thumbnail-classic" href="../intense-product/index.html" target="_blank">
                            <figure><img width="570" height="428" src="images/childs/intense-product-570x428.jpg" alt="">
                              <figcaption class="thumbnail-classic-caption text-center">
                                <h4 class="thumbnail-classic-title text-uppercase text-darkest">Intense Product</h4>
                                <p class="thumbnail-classic-desc text-bold text-uppercase veil reveal-xs-block">Best for IT products</p>
                              </figcaption>
                            </figure></a>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 col-xl-4 isotope-item" data-filter="Creative">
                        <div class="shadow-variant-2"><a class="thumbnail-classic" href="../intense-application/index.html" target="_blank">
                            <figure><img width="570" height="428" src="images/childs/intense-aplication-570x428.jpg" alt="">
                              <figcaption class="thumbnail-classic-caption text-center">
                                <h4 class="thumbnail-classic-title text-uppercase text-darkest">Intense app</h4>
                                <p class="thumbnail-classic-desc text-bold text-uppercase veil reveal-xs-block">Best for applications</p>
                              </figcaption>
                            </figure></a>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 col-xl-4 isotope-item" data-filter="Agency">
                        <div class="shadow-variant-2"><a class="thumbnail-classic" href="../intense-startup/index.html" target="_blank">
                            <figure><img width="570" height="428" src="images/childs/intense-startup-570x428.jpg" alt="">
                              <figcaption class="thumbnail-classic-caption text-center">
                                <h4 class="thumbnail-classic-title text-uppercase text-darkest">Intense startup</h4>
                                <p class="thumbnail-classic-desc text-bold text-uppercase veil reveal-xs-block">Best for startups</p>
                              </figcaption>
                            </figure></a>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 col-xl-4 isotope-item" data-filter="Creative">
                        <div class="shadow-variant-2"><a class="thumbnail-classic" href="../intense-book/index.html" target="_blank">
                            <figure><img width="570" height="428" src="images/childs/intense-book-570x428.jpg" alt="">
                              <figcaption class="thumbnail-classic-caption text-center">
                                <h4 class="thumbnail-classic-title text-uppercase text-darkest">Intense book</h4>
                                <p class="thumbnail-classic-desc text-bold text-uppercase veil reveal-xs-block">Best for books</p>
                              </figcaption>
                            </figure></a>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 col-xl-4 isotope-item" data-filter="Agency">
                        <div class="shadow-variant-2"><a class="thumbnail-classic" href="../intense-travel/index.html" target="_blank">
                            <figure><img width="570" height="428" src="images/childs/intense-travel-570x428.jpg" alt="">
                              <figcaption class="thumbnail-classic-caption text-center">
                                <h4 class="thumbnail-classic-title text-uppercase text-darkest">Intense travel</h4>
                                <p class="thumbnail-classic-desc text-bold text-uppercase veil reveal-xs-block">Best for travel agencies</p>
                              </figcaption>
                            </figure></a>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 col-xl-4 isotope-item" data-filter="Creative">
                        <div class="shadow-variant-2"><a class="thumbnail-classic" href="../intense-event/index.html" target="_blank">
                            <figure><img width="570" height="428" src="images/childs/intense-event-570x428.jpg" alt="">
                              <figcaption class="thumbnail-classic-caption text-center">
                                <h4 class="thumbnail-classic-title text-uppercase text-darkest">Intense event</h4>
                                <p class="thumbnail-classic-desc text-bold text-uppercase veil reveal-xs-block">Best for meetup</p>
                              </figcaption>
                            </figure></a>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 col-xl-4 isotope-item" data-filter="Agency">
                        <div class="shadow-variant-2"><a class="thumbnail-classic" href="../landing-agency/index.html" target="_blank">
                            <figure><img width="570" height="428" src="images/childs/landing-agency-570x428.jpg" alt="">
                              <figcaption class="thumbnail-classic-caption text-center">
                                <h4 class="thumbnail-classic-title text-uppercase text-darkest">Agency landing</h4>
                                <p class="thumbnail-classic-desc text-bold text-uppercase veil reveal-xs-block">Best agency landing</p>
                              </figcaption>
                            </figure></a>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 col-xl-4 isotope-item" data-filter="Agency">
                        <div class="shadow-variant-2"><a class="thumbnail-classic" href="../landing-business/index.html" target="_blank">
                            <figure><img width="570" height="428" src="images/childs/landing-business-570x428.jpg" alt="">
                              <figcaption class="thumbnail-classic-caption text-center">
                                <h4 class="thumbnail-classic-title text-uppercase text-darkest">Business landing</h4>
                                <p class="thumbnail-classic-desc text-bold text-uppercase veil reveal-xs-block">Best business landing</p>
                              </figcaption>
                            </figure></a>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 col-xl-4 isotope-item" data-filter="Agency">
                        <div class="shadow-variant-2"><a class="thumbnail-classic" href="../landing-corporate/index.html" target="_blank">
                            <figure><img width="570" height="428" src="images/childs/landing-corporate-570x428.jpg" alt="">
                              <figcaption class="thumbnail-classic-caption text-center">
                                <h4 class="thumbnail-classic-title text-uppercase text-darkest">Corporate landing</h4>
                                <p class="thumbnail-classic-desc text-bold text-uppercase veil reveal-xs-block">Best corporate landing</p>
                              </figcaption>
                            </figure></a>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 col-xl-4 isotope-item" data-filter="Agency">
                        <div class="shadow-variant-2"><a class="thumbnail-classic" href="../landing-personal/index.html" target="_blank">
                            <figure><img width="570" height="428" src="images/childs/landing-personal-570x428.jpg" alt="">
                              <figcaption class="thumbnail-classic-caption text-center">
                                <h4 class="thumbnail-classic-title text-uppercase text-darkest">Personal landing</h4>
                                <p class="thumbnail-classic-desc text-bold text-uppercase veil reveal-xs-block">Best personal landing</p>
                              </figcaption>
                            </figure></a>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 col-xl-4 isotope-item" data-filter="Agency">
                        <div class="shadow-variant-2"><a class="thumbnail-classic" href="../landing-shop/index.html" target="_blank">
                            <figure><img width="570" height="428" src="images/childs/landing-shop-570x428.jpg" alt="">
                              <figcaption class="thumbnail-classic-caption text-center">
                                <h4 class="thumbnail-classic-title text-uppercase text-darkest">Shop landing</h4>
                                <p class="thumbnail-classic-desc text-bold text-uppercase veil reveal-xs-block">Best shop landing</p>
                              </figcaption>
                            </figure></a>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 col-xl-4 isotope-item" data-filter="Creative">
                        <div class="shadow-variant-2"><a class="thumbnail-classic" href="../landing-startup/index.html" target="_blank">
                            <figure><img width="570" height="428" src="images/childs/landing-startup-570x428.jpg" alt="">
                              <figcaption class="thumbnail-classic-caption text-center">
                                <h4 class="thumbnail-classic-title text-uppercase text-darkest">Startup landing</h4>
                                <p class="thumbnail-classic-desc text-bold text-uppercase veil reveal-xs-block">Best startup landing</p>
                              </figcaption>
                            </figure></a>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 col-xl-4 isotope-item" data-filter="Agency">
                        <div class="shadow-variant-2"><a class="thumbnail-classic" href="../intense-taxi/index.html" target="_blank">
                            <figure><img width="570" height="428" src="images/childs/intense-taxi-570x428.jpg" alt="">
                              <figcaption class="thumbnail-classic-caption text-center">
                                <h4 class="thumbnail-classic-title text-uppercase text-darkest">Intense taxi</h4>
                                <p class="thumbnail-classic-desc text-bold text-uppercase veil reveal-xs-block">Best for taxi</p>
                              </figcaption>
                            </figure></a>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 col-xl-4 isotope-item" data-filter="Agency">
                        <div class="shadow-variant-2"><a class="thumbnail-classic" href="../intense-barbershop/index.html" target="_blank">
                            <figure><img width="570" height="428" src="images/childs/intense-barbershop-570x428.jpg" alt="">
                              <figcaption class="thumbnail-classic-caption text-center">
                                <h4 class="thumbnail-classic-title text-uppercase text-darkest">Intense barbershop</h4>
                                <p class="thumbnail-classic-desc text-bold text-uppercase veil reveal-xs-block">Best for barbershop</p>
                              </figcaption>
                            </figure></a>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 col-xl-4 isotope-item" data-filter="Agency">
                        <div class="shadow-variant-2"><a class="thumbnail-classic" href="../intense-pet-shop/index.html" target="_blank">
                            <figure><img width="570" height="428" src="images/childs/intense-pet-shop-570x428.jpg" alt="">
                              <figcaption class="thumbnail-classic-caption text-center">
                                <h4 class="thumbnail-classic-title text-uppercase text-darkest">Intense pet shop</h4>
                                <p class="thumbnail-classic-desc text-bold text-uppercase veil reveal-xs-block">Best for pet shop</p>
                              </figcaption>
                            </figure></a>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 col-xl-4 isotope-item" data-filter="Infrastructure">
                        <div class="shadow-variant-2"><a class="thumbnail-classic" href="../car-repair/index.html" target="_blank">
                            <figure><img width="570" height="428" src="images/childs/car-repair-570x428.jpg" alt="">
                              <figcaption class="thumbnail-classic-caption text-center">
                                <h4 class="thumbnail-classic-title text-uppercase text-darkest">Car Repair</h4>
                                <p class="thumbnail-classic-desc text-bold text-uppercase veil reveal-xs-block">Best for repair services</p>
                              </figcaption>
                            </figure></a>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 col-xl-4 isotope-item" data-filter="Creative">
                        <div class="shadow-variant-2"><a class="thumbnail-classic" href="../black-friday/index.html" target="_blank">
                            <figure><img width="570" height="428" src="images/childs/black-friday-570x428.jpg" alt="">
                              <figcaption class="thumbnail-classic-caption text-center">
                                <h4 class="thumbnail-classic-title text-uppercase text-darkest">Black Friday</h4>
                                <p class="thumbnail-classic-desc text-bold text-uppercase veil reveal-xs-block">Best promo</p>
                              </figcaption>
                            </figure></a>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 col-xl-4 isotope-item" data-filter="Creative">
                        <div class="shadow-variant-2"><a class="thumbnail-classic" href="../christmas-cards/index.html" target="_blank">
                            <figure><img width="570" height="428" src="images/childs/christmas-cards-570x428.jpg" alt="">
                              <figcaption class="thumbnail-classic-caption text-center">
                                <h4 class="thumbnail-classic-title text-uppercase text-darkest">Christmas Cards</h4>
                                <p class="thumbnail-classic-desc text-bold text-uppercase veil reveal-xs-block">Nice greetings</p>
                              </figcaption>
                            </figure></a>
                        </div>
                      </div>
      ...
      <!-- Meet our team-->
      <section class="section-98 section-sm-110 section-bottom-66 bg-lightest">
        <div class="container">
          <h1 class="font-weight-bold text-primary">Meet Our Team</h1>
          <svg height="13" viewbox="0 0 71 13" width="71" xmlns="http://www.w3.org/2000/svg" version="1.1">
            <path class="bg-primary" d="M 65.591797,0.39453125 C 64.632414,0.55512546 63.656631,1.037019 62.839844,1.9121094 l 2.009765,1.875 c 0.987119,-1.0575807 1.464926,-0.9055776 2.074219,-0.5703125 0.609293,0.335265 1.125342,1.2616345 1.144531,1.6152343 C 68.111503,5.6270437 67.786283,6.2015228 66.951172,6.875 66.116061,7.5484772 64.791442,8.161997 63.316406,8.6230469 60.366335,9.5451467 56.822431,9.9000923 55.357422,9.9453125 49.487597,10.126495 41.515727,8.2106051 34.380859,5.9648438 30.873861,4.8609863 26.209294,2.9728751 21.335938,1.7480469 16.462581,0.52321864 11.317182,-0.07967759 6.7734375,1.6503906 l -0.025391,0.00977 -0.025391,0.00977 C 4.3944177,2.6636873 2.6199428,4.0438286 1.515625,5.5957031 0.41130724,7.1475776 -0.0588551,9.0257429 0.7265625,10.642578 c 0.735964,1.515031 2.2978692,2.250647 3.6972656,2.234375 1.3993964,-0.01627 2.7415813,-0.606444 3.6738281,-1.679687 L 6.0214844,9.3945312 C 5.6678168,9.8016889 4.967102,10.122226 4.3925781,10.128906 3.8180543,10.135587 3.4724885,10.00395 3.1992188,9.4414062 2.9754025,8.9806654 3.024638,8.2170231 3.7558594,7.1894531 4.4839472,6.1662866 5.8567444,5.037042 7.78125,4.2109375 c 3.674744,-1.3881932 8.271853,-0.9562457 12.884766,0.203125 4.624565,1.1622992 9.200779,3.012418 12.890625,4.1738281 7.258822,2.2847774 15.360414,4.3068544 21.884765,4.1054684 1.739141,-0.05368 5.355814,-0.40149 8.695313,-1.445312 1.669749,-0.521911 3.270286,-1.207639 4.541015,-2.232422 C 69.948464,7.990842 70.909328,6.4678364 70.8125,4.6835938 70.724917,3.0697107 69.754257,1.63739 68.248047,0.80859375 67.494942,0.39419565 66.55118,0.23393704 65.591797,0.39453125 Z"></path>
          </svg>
          <div class="offset-md-top-34 text-center text-lg-left">
            <div class="row justify-content-sm-center section-34">
              <div class="col-md-6 col-lg-3"><img class="img-fluid d-inline-block" src="images/users/user-ashley-masson-270x270.jpg" width="270" height="270" alt="">
                <div class="text-lg-left offset-top-14">
                  <div>
                    <h5 class="font-weight-bold text-safety-orange font-default"><a href="team-member.html">Ashley Mason</a></h5>
                  </div>
                </div>
                <address class="contact-info text-lg-left post-meta offset-top-10">
                  <ul class="list-unstyled p">
                    <li class="d-block"><span class="icon novi-icon icon-xxs mdi mdi-phone text-middle text-dark"></span><a class="d-inline-block text-middle inset-left-10" href="tel:1-800-7650-986">1-800-7650-986</a></li>
                    <li class="d-block"><span class="icon novi-icon icon-xxs mdi mdi-email-open text-middle text-dark"></span><a class="d-inline-block text-middle inset-left-10" href="mailto:ashley@demolink.org">ashley@demolink.org</a></li>
                  </ul>
                </address>
              </div>
              <div class="col-md-6 col-lg-3 offset-top-50 offset-md-top-0"><img class="img-fluid d-inline-block" src="images/users/user-alisa-myers-270x270.jpg" width="270" height="270" alt="">
                <div class="text-lg-left offset-top-14">
                  <div>
                    <h5 class="font-weight-bold text-safety-orange font-default"><a href="team-member.html">Alisa Myers</a></h5>
                  </div>
                </div>
                <address class="contact-info text-lg-left post-meta offset-top-10">
                  <ul class="list-unstyled p">
                    <li class="d-block"><span class="icon novi-icon icon-xxs mdi mdi-phone text-middle text-dark"></span><a class="d-inline-block text-middle inset-left-10" href="tel:1-800-7650-986">1-800-7650-986</a></li>
                    <li class="d-block"><span class="icon novi-icon icon-xxs mdi mdi-email-open text-middle text-dark"></span><a class="d-inline-block text-middle inset-left-10" href="mailto:alisa@demolink.org">alisa@demolink.org</a></li>
                  </ul>
                </address>
              </div>
              <div class="col-md-6 col-lg-3 offset-top-50 offset-lg-top-0"><img class="img-fluid d-inline-block" src="images/users/user-shirley-vasques-270x270.jpg" width="270" height="270" alt="">
                <div class="text-lg-left offset-top-14">
                  <div>
                    <h5 class="font-weight-bold text-safety-orange font-default"><a href="team-member.html">Shirley Vasquez</a></h5>
                  </div>
                </div>
                <address class="contact-info text-lg-left post-meta offset-top-10">
                  <ul class="list-unstyled p">
                    <li class="d-block"><span class="icon novi-icon icon-xxs mdi mdi-phone text-middle text-dark"></span><a class="d-inline-block text-middle inset-left-10" href="tel:1-800-7650-986">1-800-7650-986</a></li>
                    <li class="d-block"><span class="icon novi-icon icon-xxs mdi mdi-email-open text-middle text-dark"></span><a class="d-inline-block text-middle inset-left-10" href="mailto:shirley@demolink.org">shirley@demolink.org</a></li>
                  </ul>
                </address>
              </div>
              <div class="col-md-6 col-lg-3 offset-top-50 offset-lg-top-0"><img class="img-fluid d-inline-block" src="images/users/user-terry-sandoval-270x270.jpg" width="270" height="270" alt="">
                <div class="text-lg-left offset-top-14">
                  <div>
                    <h5 class="font-weight-bold text-safety-orange font-default"><a href="team-member.html">Terry Sandoval</a></h5>
                  </div>
                </div>
                <address class="contact-info text-lg-left post-meta offset-top-10">
                  <ul class="list-unstyled p">
                    <li class="d-block"><span class="icon novi-icon icon-xxs mdi mdi-phone text-middle text-dark"></span><a class="d-inline-block text-middle inset-left-10" href="tel:1-800-7650-986">1-800-7650-986</a></li>
                    <li class="d-block"><span class="icon novi-icon icon-xxs mdi mdi-email-open text-middle text-dark"></span><a class="d-inline-block text-middle inset-left-10" href="mailto:terry@demolink.org">terry@demolink.org</a></li>
                  </ul>
                </address>
              </div>
            </div>
      ...
      <!-- Testimonials-->
      <section class="section parallax-container" data-parallax-img="images/skins/skin-eternal-joy-02-1920x748.jpg">
        <div class="parallax-content section-98 section-md-124 context-dark">
          <div class="container">
              ...
              <div class="col-sm-10 col-md-7 col-lg-4">
                ...
                <blockquote class="quote quote-classic quote-classic-boxed">
                  <div class="quote-body bg-white text-darker">
                    <p>
                      <q>Lorem ipsum dolor sit amet conse ctetur adip isicing elit, sed do eiusmod tempor incididunt ut labore et dolore </q>
                    </p>
                    <div class="quote-meta"><img class="rounded-circle quote-img" width="80" height="80" src="images/users/user-alex-ross-80x80.jpg" alt=""></div>
                  </div>
                  <h6 class="quote-author text-uppercase font-weight-bold font-default">
                    <cite class="text-normal">Alex Ross</cite>
                  </h6>
                  <p class="quote-desc">Ceo/Founder at demolink.com</p>
                </blockquote>
              </div>
              <div class="col-sm-10 col-md-7 col-lg-4 offset-top-50 offset-lg-top-0">
                ...
                <blockquote class="quote quote-classic quote-classic-boxed">
                  <div class="quote-body bg-white text-darker">
                    ...
                    <div class="quote-meta"><img class="rounded-circle quote-img" width="80" height="80" src="images/users/user-alisa-milano-80x80.jpg" alt=""></div>
                  </div>
                  <h6 class="quote-author text-uppercase font-weight-bold font-default">
                    <cite class="text-normal">Alisa Milano</cite>
                  </h6>
                  <p class="quote-desc">Sales at demolink.com</p>
                </blockquote>
              </div>
              <div class="col-sm-10 col-md-7 col-lg-4 offset-top-50 offset-lg-top-0">
                <!-- Boxed Testimonials-->
                <blockquote class="quote quote-classic quote-classic-boxed">
                  <div class="quote-body bg-white text-darker">
                    ...
                    <div class="quote-meta"><img class="rounded-circle quote-img" width="80" height="80" src="images/users/user-john-more-80x80.jpg" alt=""></div>
                  </div>
                  <h6 class="quote-author text-uppercase font-weight-bold font-default">
                    <cite class="text-normal">john More</cite>
                  </h6>
                  <p class="quote-desc">Support at demolink.com</p>
                </blockquote>
              </div>
            </div>
          </div>
      ...
      <footer class="section novi-background section-relative section-top-66 section-bottom-34 page-footer">
            ...
            <div class="col-md-8 col-lg-12">
              <div class="row justify-content-sm-center">
                <div class="col-lg-5 order-lg-2">
                  <h6 class="text-uppercase text-spacing-60 font-default">Newsletter</h6>
                ...
                <div class="col-lg-4 offset-top-50 offset-lg-top-0 order-lg-3 col-xl-3 offset-xl-1">
                  <ul class="list list-unstyled address contact-info text-left">
                    <li>
                      <div class="unit unit-spacing-xxs flex-row">
                        <div class="unit-left"><span class="icon novi-icon icon-xxs mdi mdi-phone text-primary text-middle"></span></div>
                        <div class="unit-body"><a class="text-middle" href="tel:#">1-800-1234-567</a></div>
                      </div>
                    </li>
                    <li>
                      <div class="unit unit-spacing-xxs flex-row">
                        <div class="unit-left"><span class="icon novi-icon icon-xxs mdi mdi-map-marker-radius text-primary text-middle"></span></div>
                        <div class="unit-body"><span class="text-middle">2130 Fulton Street, San Francisco, CA 94117-1080 USA</span></div>
                      </div>
                    </li>
                    <li>
                      <div class="unit unit-spacing-xxs flex-row">
                        <div class="unit-left"><span class="icon novi-icon icon-xxs mdi mdi-clock text-primary text-middle"></span></div>
                        <div class="unit-body"><span class="text-middle">Mon–Sat: 7:00am–8:00pm</span></div>
                      </div>
                    </li>
                  </ul>
                </div>
                <div class="col-lg-3 offset-top-50 offset-lg-top-0 order-lg-1">
                  <!-- Footer brand-->
                  <div class="footer-brand text-center text-lg-left"><a class="d-inline-block" href="index.html"><img class="img-fluid" width="135" height="55" src="images/childs/intense-child-care-logo-dark.png" alt=""></a></div>
                  <ul class="list-inline list-inline-xxs d-inline-block offset-top-34 post-meta text-dark list-inline-primary">
                    <li class="list-inline-item"><a href="#"><span class="icon novi-icon icon-xxs fa-facebook"></span></a></li>
                    <li class="list-inline-item"><a href="#"><span class="icon novi-icon icon-xxs fa-twitter"></span></a></li>
                    <li class="list-inline-item"><a href="#"><span class="icon novi-icon icon-xxs fa-google-plus"></span></a></li>
                    <li class="list-inline-item"><a href="#"><span class="icon novi-icon icon-xxs fa-youtube-play"></span></a></li>
                    <li class="list-inline-item"><a href="#"><span class="icon novi-icon icon-xxs fa-instagram"></span></a></li>
                  </ul>
                </div>
              </div>
            </div>
        ...
        <div class="container offset-top-50">
          <p class="small text-dark">Intense &copy; <span class="copyright-year"></span> . <a href="privacy.html">Privacy Policy</a></p>
        </div>
      </footer>
    </div>
