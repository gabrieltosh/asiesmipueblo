...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <body>
    ...
    <div class="page text-center">
          ...
          <nav class="rd-navbar rd-navbar-default rd-navbar-transparent" data-md-device-layout="rd-navbar-fixed" data-lg-device-layout="rd-navbar-static" data-lg-auto-height="true" data-md-layout="rd-navbar-fixed" data-lg-layout="rd-navbar-static" data-lg-stick-up="true">
            <div class="rd-navbar-inner">
              ...
              <div class="rd-navbar-menu-wrap">
                <div class="rd-navbar-nav-wrap">
                  <div class="rd-navbar-mobile-scroll">
                    ...
                    <ul class="rd-navbar-nav">
                      <li class="active"><a href="index.html"><span>Home</span><span class="rd-navbar-label text-middle label-custom label-xs-custom label-rounded-custom label label-info">novi</span></a>
                        <ul class="rd-navbar-dropdown">
                          <li><a href="#"><span class="text-middle">Child Themes</span><span class="rd-navbar-label label-custom label-xs-custom label-rounded-custom label label-info">novi</span></a>
                            <ul class="rd-navbar-dropdown">
                              ...
                              <li><a href="../car-repair/index.html"><span class="text-middle">Car Repair</span></a>
                              </li>
                            </ul>
                          </li>
                          <li><a href="#"><span class="text-middle">Landing pages</span><span class="rd-navbar-label label-custom label-xs-custom label-rounded-custom label label-info">novi</span></a>
                            <ul class="rd-navbar-dropdown">
                              <li><a href="../intense-application/index.html"><span class="text-middle">Application</span></a>
                              </li>
                              <li><a href="../intense-book/index.html"><span class="text-middle">Book</span></a>
                              </li>
                              <li><a href="../intense-product/index.html"><span class="text-middle">Product</span></a>
                              </li>
                              <li><a href="../intense-travel/index.html"><span class="text-middle">Travel</span></a>
                              </li>
                              <li><a href="../intense-startup/index.html"><span class="text-middle">Startup</span></a>
                              </li>
                              <li><a href="../intense-event/index.html"><span class="text-middle">Event</span></a>
                              </li>
                              <li><a href="../landing-agency/index.html"><span class="text-middle">Agency</span></a>
                              </li>
                              <li><a href="../landing-business/index.html"><span class="text-middle">Business</span></a>
                              </li>
                              <li><a href="../landing-corporate/index.html"><span class="text-middle">Corporate</span></a>
                              </li>
                              <li><a href="../landing-personal/index.html"><span class="text-middle">Personal</span></a>
                              </li>
                              <li><a href="../landing-shop/index.html"><span class="text-middle">Shop</span></a>
                              </li>
                              <li><a href="../landing-startup/index.html"><span class="text-middle">Startup</span></a>
                              </li>
                              <li><a href="../black-friday/index.html"><span class="text-middle">Black Friday</span></a>
                              </li>
                              <li><a href="../christmas-cards/index.html"><span class="text-middle">Christmas Cards</span></a>
                              </li>
                            </ul>
                          </li>
                ...
                <div class="rd-navbar-btn-wrap"><a class="btn btn-primary btn-anis-effect" href="//novibuilder.com/documentation/" target="_blank"><span class="btn-text">Try Builder</span></a></div>
              </div>
            </div>
          </nav>
        </div>
                  ...
                  <div class="container">
                    <div class="row justify-content-xl-center">
                      ...
                      <div class="col-xl-10 offset-top-30">
                        <h4 class="d-none d-md-block text-light" data-caption-animate="fadeIn" data-caption-delay="900">
                            ...
                            <div class="container">
                              <div class="row justify-content-xl-center">
                                ...
                                <div class="col-xl-10 offset-top-30">
                                  ...
                                  <div class="group group-xl offset-top-20 offset-sm-top-50"><a class="btn btn-icon btn-icon-left btn-default btn-lg btn-anis-effect" href="ui-kit.html" data-caption-animate="fadeIn" data-caption-delay="1200"><span class="btn-text">See it in action</span></a></div>
                                </div>
                              </div>
                            </div>
                          </div>
                ...
                <div class="swiper-slide-caption">
                  <div class="container">
                    <div class="row justify-content-xl-center">
                      ...
                      <div class="col-xl-10 offset-top-30">
                        <h4 class="d-none d-md-block text-light offset-bottom-0" data-caption-animate="fadeIn" data-caption-delay="900">
                          Beautiful and clean designs are optimized for all screen sizes
                          and types. Taste a new meaning of Retina Ready.
                        </h4>
                        <div class="group group-xl offset-top-20 offset-sm-top-50"><a class="btn btn-icon btn-icon-left btn-primary btn-lg btn-anis-effect" href="//documentation.zemez.io/html/bootstrap/intense/" target="_blank" data-caption-animate="fadeIn" data-caption-delay="1200"><span class="novi-icon icon mdi mdi-cart-outline"></span><span class="btn-text">Buy intense now</span></a></div>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <!-- Skills-->
      <section class="section novi-background section-66 section-lg-98" id="section-skills">
          ...
          <div class="row justify-content-sm-center grid-group-md">
            <div class="col-sm-6 col-md-5 col-lg-3">
                    ...
                    <div class="counter-type-2"><span class="icon novi-icon linearicons-file-code text-mantis"></span>
                      <div class="offset-top-10"><span class="h1 font-weight-bold counter" data-speed="1200" data-from="0" data-to="500"></span><span class="h1 font-weight-bold">+</span>
                      </div>
                      <div class="offset-xxl-top-10">
                        <div class="h6 text-uppercase text-spacing-60 font-weight-bold">html Templates</div>
                      </div>
                    </div>
            </div>
            <div class="col-sm-6 col-md-5 col-lg-3">
                    ...
                    <div class="counter-type-2"><span class="icon novi-icon linearicons-star text-malibu"></span>
                      <div class="offset-top-10"><span class="h1 font-weight-bold counter" data-speed="1600" data-from="0" data-to="25"></span><span class="h1 font-weight-bold">+</span>
                      </div>
                      <div class="offset-xxl-top-10">
                        <div class="h6 text-uppercase text-spacing-60 font-weight-bold">niche templates</div>
                      </div>
                    </div>
            </div>
            <div class="col-sm-6 col-md-5 col-lg-3">
                    ...
                    <div class="counter-type-2"><span class="icon novi-icon linearicons-palette text-carrot"></span>
                      <div class="offset-top-10"><span class="h1 font-weight-bold counter" data-speed="2000" data-from="0" data-to="10"></span>
                      </div>
                      <div class="offset-xxl-top-10">
                        <div class="h6 text-uppercase text-spacing-60 font-weight-bold">different skins</div>
                      </div>
                    </div>
            </div>
            <div class="col-sm-6 col-md-5 col-lg-3">
                    ...
                    <div class="counter-type-2"><span class="icon novi-icon linearicons-file-image text-red"></span>
                      <div class="offset-top-10"><span class="h1 font-weight-bold counter" data-speed="2400" data-from="0" data-to="500"></span><span class="h1 font-weight-bold">+</span>
                      </div>
                      <div class="offset-xxl-top-10">
                        <div class="h6 text-uppercase text-spacing-60 font-weight-bold">psd files</div>
                      </div>
                    </div>
            </div>
          </div>
          ...
          <div class="offset-lg-top-30 offset-xxl-top-66 text-lg-left">
            <div class="row justify-content-lg-center justify-content-xxl-between grid-group-md">
              <div class="col-lg-6 col-xl-5">
                ...
                <div class="offset-top-41"><a class="btn btn-primary btn-md btn-anis-effect" href="//novibuilder.com/documentation/" target="_blank"><span class="btn-text">Try Builder</span></a></div>
              </div>
              <div class="col-lg-6">
                <div class="embed-responsive embed-responsive-16by9">
                  <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/e_TCFkRDmls" allowfullscreen></iframe>
                </div>
              </div>
            </div>
          </div>
      ...
      <!-- Our Works -->
      <section class="section novi-background section-66 section-xl-110 smooth" id="section-childs">
        <div class="container-fluid">
          <div>
          ...
          <div class="offset-top-10 offset-lg-top-20 offset-xxl-top-66">
            <h3 class="text-regular">Check out other themes based on<span class="text-uppercase text-ubold text-mantis"> Intense</span></h3>
          </div>
          <div class="offset-top-30 offset-xxl-top-66">
            <div class="row grid-group-md">
              <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><a class="thumbnail-simple" target="_blank" href="index-variant-2.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-03-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Intense Main Theme</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
                        </div></a>
              </div>
              <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><a class="thumbnail-simple" target="_blank" href="../intense-job-board/index.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-04-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Intense Job Board</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
              ...
              <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><a class="thumbnail-simple" target="_blank" href="../intense-child-care/index.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-05-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Intense Child Care</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
              ...
              <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><a class="thumbnail-simple" target="_blank" href="../intense-financial-analytic/index.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-06-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Intense Financial Advisor</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
              ...
              <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><a class="thumbnail-simple" target="_blank" href="../intense-gym/index.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-07-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Intense Gym</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
              ...
              <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><a class="thumbnail-simple" target="_blank" href="../intense-dental-clinic/index.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-08-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Intense Dental Clinic</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
              ...
              <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><a class="thumbnail-simple" target="_blank" href="../intense-handmade/index.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-09-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Intense Handmade</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
              ...
              <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><a class="thumbnail-simple" target="_blank" href="../intense-real-estate/index.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-10-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Intense Real Estate</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
              ...
              <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><a class="thumbnail-simple" target="_blank" href="../intense-personal-blog/index.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-11-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Intense Personal Blog</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
              ...
              <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><a class="thumbnail-simple" target="_blank" href="../intense-photographer-portfolio/index.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-12-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Intense Photographer</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
              ...
              <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><a class="thumbnail-simple" target="_blank" href="../intense-restaurant/index.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-13-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Intense Restaurant</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
              ...
              <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><a class="thumbnail-simple" target="_blank" href="../intense-product/index.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-14-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Intense Product</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
              ...
              <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><a class="thumbnail-simple" target="_blank" href="../intense-application/index.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-15-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Intense app</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
              ...
              <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><a class="thumbnail-simple" target="_blank" href="../intense-startup/index.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-16-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Intense startup</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
              ...
              <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><a class="thumbnail-simple" target="_blank" href="../intense-book/index.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-18-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Intense book</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
              ...
              <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><a class="thumbnail-simple" target="_blank" href="../intense-travel/index.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-19-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Intense travel</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
              ...
              <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><a class="thumbnail-simple" target="_blank" href="../intense-event/index.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-20-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Intense event</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
              ...
              <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><a class="thumbnail-simple" target="_blank" href="../landing-agency/index.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-24-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Agency landing</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
              ...
              <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><a class="thumbnail-simple" target="_blank" href="../landing-business/index.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-25-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Business landing</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
              ...
              <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><a class="thumbnail-simple" target="_blank" href="../landing-corporate/index.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-26-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Corporate landing</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
              ...
              <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><a class="thumbnail-simple" target="_blank" href="../landing-personal/index.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-27-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Personal landing</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
              ...
              <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><a class="thumbnail-simple" target="_blank" href="../landing-shop/index.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-28-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Shop landing</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
              ...
              <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><a class="thumbnail-simple" target="_blank" href="../landing-startup/index.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-29-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Startup landing</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
              ...
              <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><a class="thumbnail-simple" target="_blank" href="../intense-taxi/index.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-21-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Intense taxi</span><span class="label label-custom label-sm-custom label-rounded-custom label-info">bs3</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
              ...
              <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><a class="thumbnail-simple" target="_blank" href="../intense-barbershop/index.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-22-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Intense barbershop</span><span class="label label-custom label-sm-custom label-rounded-custom label-info">bs3</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
              ...
              <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><a class="thumbnail-simple" target="_blank" href="../intense-pet-shop/index.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-23-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Intense pet shop</span><span class="label label-custom label-sm-custom label-rounded-custom label-info">bs3</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
              ...
              <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><a class="thumbnail-simple" target="_blank" href="../car-repair/index.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-116-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Car Repair</span><span class="label label-custom label-sm-custom label-rounded-custom label-info">bs3</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
              ...
              <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><a class="thumbnail-simple" target="_blank" href="../black-friday/index.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-117-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Black Friday</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
              ...
              <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3"><a class="thumbnail-simple" target="_blank" href="../christmas-cards/index.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-118-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Christmas Cards</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
      ...
      <section class="section novi-background section-66 section-xl-110 bg-lighter">
        <div class="container-fluid">
          <h2><span class="big">Best-Selling & Most Trusted</span><span class="big text-mantis"> HTML5</span><span class="big"> Template</span></h2>
          <p class="text-dark">Experience the Ever-Growing Feature Rich Template since 2019</p>
        </div>
      </section>
      <!-- Page Layouts-->
      <section class="section novi-background section-66 section-xl-110">
        <div class="container container-wide">
          ...
          <div class="offset-top-20 offset-xxl-top-41">
                    ...
                    <div class="row">
                          ...
                          <ul class="list-inline list-inline-sm">
                            ...
                            <li class="list-inline-item section-relative">
                              ...
                              <ul class="list-sm-inline isotope-filters-list" id="isotope-1">
                                ...
                                <li class="list-inline-item"><a class="font-weight-bold" data-isotope-filter="Types" data-isotope-group="gallery" href="#">Types</a></li>
                                <li class="list-inline-item"><a class="font-weight-bold" data-isotope-filter="Skins" data-isotope-group="gallery" href="#">Skins</a></li>
                                <li class="list-inline-item"><a class="font-weight-bold" data-isotope-filter="Intro" data-isotope-group="gallery" href="#">Intro</a></li>
                              </ul>
                            </li>
                          </ul>
                        </div>
                      ...
                      <div class="col-xl-12 offset-top-34">
                        <div class="isotope" data-isotope-layout="fitRows" data-isotope-group="gallery">
                          <div class="row grid-group-md">
                            <div class="col-12 col-md-6 col-lg-4 col-xl-3 isotope-item" data-filter="Types"><a class="thumbnail-simple" target="_blank" href="index.html">
                                      <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-30-420x316.jpg" alt=""></div>
                                      <div class="offset-top-14 offset-xxl-top-20">
                                        <h4><span class="caption font-weight-bold text-middle">Home Default</span>
                                        </h4>
                                      </div>
                                      <div class="offset-xxl-top-14 d-none d-xxl-block">
                                        <hr class="divider divider-xs bg-mantis">
                            ...
                            <div class="col-12 col-md-6 col-lg-4 col-xl-3 isotope-item" data-filter="Types"><a class="thumbnail-simple" target="_blank" href="index-one-page.html">
                                      <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-31-420x316.jpg" alt=""></div>
                                      <div class="offset-top-14 offset-xxl-top-20">
                                        <h4><span class="caption font-weight-bold text-middle">Home One Page</span>
                                        </h4>
                                      </div>
                                      <div class="offset-xxl-top-14 d-none d-xxl-block">
                                        <hr class="divider divider-xs bg-mantis">
                            ...
                            <div class="col-12 col-md-6 col-lg-4 col-xl-3 isotope-item" data-filter="Skins"><a class="thumbnail-simple" target="_blank" href="index-variant-2.html">
                                      <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-32-420x316.jpg" alt=""></div>
                                      <div class="offset-top-14 offset-xxl-top-20">
                                        <h4><span class="caption font-weight-bold text-middle">Home Default Intense</span>
                                        </h4>
                                      </div>
                                      <div class="offset-xxl-top-14 d-none d-xxl-block">
                                        <hr class="divider divider-xs bg-mantis">
                            ...
                            <div class="col-12 col-md-6 col-lg-4 col-xl-3 isotope-item" data-filter="Skins"><a class="thumbnail-simple" target="_blank" href="index-skin-sunset.html">
                                      <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-33-420x316.jpg" alt=""></div>
                                      <div class="offset-top-14 offset-xxl-top-20">
                                        <h4><span class="caption font-weight-bold text-middle">Sunset</span>
                                        </h4>
                                      </div>
                                      <div class="offset-xxl-top-14 d-none d-xxl-block">
                                        <hr class="divider divider-xs bg-mantis">
                            ...
                            <div class="col-12 col-md-6 col-lg-4 col-xl-3 isotope-item" data-filter="Skins"><a class="thumbnail-simple" target="_blank" href="index-skin-simply-chic.html">
                                      <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-34-420x316.jpg" alt=""></div>
                                      <div class="offset-top-14 offset-xxl-top-20">
                                        <h4><span class="caption font-weight-bold text-middle">Simply Chic</span>
                                        </h4>
                                      </div>
                                      <div class="offset-xxl-top-14 d-none d-xxl-block">
                                        <hr class="divider divider-xs bg-mantis">
                            ...
                            <div class="col-12 col-md-6 col-lg-4 col-xl-3 isotope-item" data-filter="Skins"><a class="thumbnail-simple" target="_blank" href="index-skin-minimal-blue.html">
                                      <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-35-420x316.jpg" alt=""></div>
                                      <div class="offset-top-14 offset-xxl-top-20">
                                        <h4><span class="caption font-weight-bold text-middle">Minimal Blue</span>
                                        </h4>
                                      </div>
                                      <div class="offset-xxl-top-14 d-none d-xxl-block">
                                        <hr class="divider divider-xs bg-mantis">
                            ...
                            <div class="col-12 col-md-6 col-lg-4 col-xl-3 isotope-item" data-filter="Skins"><a class="thumbnail-simple" target="_blank" href="index-skin-sunrise.html">
                                      <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-36-420x316.jpg" alt=""></div>
                                      <div class="offset-top-14 offset-xxl-top-20">
                                        <h4><span class="caption font-weight-bold text-middle">Sunrise</span>
                                        </h4>
                                      </div>
                                      <div class="offset-xxl-top-14 d-none d-xxl-block">
                                        <hr class="divider divider-xs bg-mantis">
                            ...
                            <div class="col-12 col-md-6 col-lg-4 col-xl-3 isotope-item" data-filter="Skins"><a class="thumbnail-simple" target="_blank" href="index-skin-renaissance.html">
                                      <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-37-420x316.jpg" alt=""></div>
                                      <div class="offset-top-14 offset-xxl-top-20">
                                        <h4><span class="caption font-weight-bold text-middle">Renaissance</span>
                                        </h4>
                                      </div>
                                      <div class="offset-xxl-top-14 d-none d-xxl-block">
                                        <hr class="divider divider-xs bg-mantis">
                            ...
                            <div class="col-12 col-md-6 col-lg-4 col-xl-3 isotope-item" data-filter="Skins"><a class="thumbnail-simple" target="_blank" href="index-skin-green-space.html">
                                      <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-38-420x316.jpg" alt=""></div>
                                      <div class="offset-top-14 offset-xxl-top-20">
                                        <h4><span class="caption font-weight-bold text-middle">Green Space</span>
                                        </h4>
                                      </div>
                                      <div class="offset-xxl-top-14 d-none d-xxl-block">
                                        <hr class="divider divider-xs bg-mantis">
                            ...
                            <div class="col-12 col-md-6 col-lg-4 col-xl-3 isotope-item" data-filter="Skins"><a class="thumbnail-simple" target="_blank" href="index-skin-red-energy.html">
                                      <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-39-420x316.jpg" alt=""></div>
                                      <div class="offset-top-14 offset-xxl-top-20">
                                        <h4><span class="caption font-weight-bold text-middle">Red Energy</span>
                                        </h4>
                                      </div>
                                      <div class="offset-xxl-top-14 d-none d-xxl-block">
                                        <hr class="divider divider-xs bg-mantis">
                            ...
                            <div class="col-12 col-md-6 col-lg-4 col-xl-3 isotope-item" data-filter="Skins"><a class="thumbnail-simple" target="_blank" href="index-skin-eternal-joy.html">
                                      <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-40-420x316.jpg" alt=""></div>
                                      <div class="offset-top-14 offset-xxl-top-20">
                                        <h4><span class="caption font-weight-bold text-middle">Eternal Joy</span>
                                        </h4>
                                      </div>
                                      <div class="offset-xxl-top-14 d-none d-xxl-block">
                                        <hr class="divider divider-xs bg-mantis">
                            ...
                            <div class="col-12 col-md-6 col-lg-4 col-xl-3 isotope-item" data-filter="Skins"><a class="thumbnail-simple" target="_blank" href="index-skin-commercial.html">
                                      <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-41-420x316.jpg" alt=""></div>
                                      <div class="offset-top-14 offset-xxl-top-20">
                                        <h4><span class="caption font-weight-bold text-middle">Commercial</span>
                                        </h4>
                                      </div>
                                      <div class="offset-xxl-top-14 d-none d-xxl-block">
                                        <hr class="divider divider-xs bg-mantis">
                            ...
                            <div class="col-12 col-md-6 col-lg-4 col-xl-3 isotope-item" data-filter="Intro"><a class="thumbnail-simple" target="_blank" href="index-promo.html">
                                      <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-42-420x316.jpg" alt=""></div>
                                      <div class="offset-top-14 offset-xxl-top-20">
                                        <h4><span class="caption font-weight-bold text-middle">Promo</span>
                                        </h4>
                                      </div>
                                      <div class="offset-xxl-top-14 d-none d-xxl-block">
                                        <hr class="divider divider-xs bg-mantis">
                            ...
                            <div class="col-12 col-md-6 col-lg-4 col-xl-3 isotope-item" data-filter="Intro"><a class="thumbnail-simple" target="_blank" href="index-fast-registration.html">
                                      <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-43-420x316.jpg" alt=""></div>
                                      <div class="offset-top-14 offset-xxl-top-20">
                                        <h4><span class="caption font-weight-bold text-middle">Fast Registration</span>
                                        </h4>
                                      </div>
                                      <div class="offset-xxl-top-14 d-none d-xxl-block">
                                        <hr class="divider divider-xs bg-mantis">
                            ...
                            <div class="col-12 col-md-6 col-lg-4 col-xl-3 isotope-item" data-filter="Intro"><a class="thumbnail-simple" target="_blank" href="index-make-an-appointment.html">
                                      <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-44-420x316.jpg" alt=""></div>
                                      <div class="offset-top-14 offset-xxl-top-20">
                                        <h4><span class="caption font-weight-bold text-middle">Appointment</span>
                                        </h4>
                                      </div>
                                      <div class="offset-xxl-top-14 d-none d-xxl-block">
                                        <hr class="divider divider-xs bg-mantis">
                            ...
                            <div class="col-12 col-md-6 col-lg-4 col-xl-3 isotope-item" data-filter="Intro"><a class="thumbnail-simple" target="_blank" href="index-video-background.html">
                                      <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-45-420x316.jpg" alt=""></div>
                                      <div class="offset-top-14 offset-xxl-top-20">
                                        <h4><span class="caption font-weight-bold text-middle">Video Background</span>
                                        </h4>
                                      </div>
                                      <div class="offset-xxl-top-14 d-none d-xxl-block">
                                        <hr class="divider divider-xs bg-mantis">
      ...
      <section class="section novi-background section-66 section-xl-110 bg-lighter">
        <div class="container-fluid">
          <h2><span class="big">Loved by</span><span class="big text-mantis"> 2800+</span><span class="big"> Happy Customers</span></h2>
          <p class="text-dark">Powered by Top-Notch Support &amp; Stellar <a class="text-primary" href="#">Customer Reviews<span class="novi-icon mdi mdi-chevron-right text-middle"></span></a>
          </p>
        </div>
      </section>
      <!-- Core features-->
            ...
            <div class="row justify-content-sm-center grid-group-md">
              <div class="col-sm-6 col-md-3 col-lg-2 col-xxl-1">
                      <div class="blurb-mini wow fadeInLeft" data-wow-delay="0.6s">
                        <div class="img-wrap bg-lighter"><img src="images/landing/landing-46-40x40.png" alt=""></div>
                        <div class="caption">Revolution Slider (15 variants)</div>
                      </div>
              </div>
              <div class="col-sm-6 col-md-3 col-lg-2 col-xxl-1">
                      <div class="blurb-mini wow fadeInLeft" data-wow-delay="0.4s">
                        <div class="img-wrap bg-lighter"><img src="images/landing/landing-48-40x40.png" alt=""></div>
                        <div class="caption">Swiper Slider</div>
                      </div>
              </div>
              <div class="col-sm-6 col-md-3 col-lg-2 col-xxl-1">
                      <div class="blurb-mini wow fadeInLeft" data-wow-delay="0.2s">
                        <div class="img-wrap bg-lighter"><img src="images/landing/landing-47-38x47.png" alt=""></div>
                        <div class="caption">Owl Carousel</div>
                      </div>
              </div>
              <div class="col-sm-6 col-md-3 col-lg-2 col-xxl-1">
                      <div class="blurb-mini wow fadeInLeft">
                        <div class="img-wrap bg-lighter"><img src="images/landing/landing-50-48x36.png" alt=""></div>
                        <div class="caption">Parallax</div>
                      </div>
              </div>
              <div class="col-sm-6 col-md-3 col-lg-2 col-xxl-1">
                      <div class="blurb-mini wow fadeInRight">
                        <div class="img-wrap bg-lighter"><img src="images/landing/landing-49-41x41.png" alt=""></div>
                        <div class="caption">Video Background</div>
                      </div>
              </div>
              <div class="col-sm-6 col-md-3 col-lg-2 col-xxl-1">
                      <div class="blurb-mini wow fadeInRight" data-wow-delay="0.2s">
                        <div class="img-wrap bg-lighter"><img src="images/landing/landing-52-32x26.png" alt=""></div>
                        <div class="caption">RD Twitter Feed</div>
                      </div>
              </div>
              <div class="col-sm-6 col-md-3 col-lg-2 col-xxl-1">
                      <div class="blurb-mini wow fadeInRight" data-wow-delay="0.4s">
                        <div class="img-wrap bg-lighter"><img src="images/landing/landing-51-15x30.png" alt=""></div>
                        <div class="caption">RD Facebook Feed</div>
                      </div>
              </div>
              <div class="col-sm-6 col-md-3 col-lg-2 col-xxl-1">
                      <div class="blurb-mini wow fadeInRight" data-wow-delay="0.6s">
                        <div class="img-wrap bg-lighter"><img src="images/landing/landing-53-43x21.png" alt=""></div>
                        <div class="caption">RD Flickr Gallery</div>
                      </div>
              </div>
              <div class="col-xxl-12 wrapper"></div>
              <div class="col-sm-6 col-md-3 col-lg-2 col-xxl-1">
                      <div class="blurb-mini wow fadeInLeft" data-wow-delay="0.6s">
                        <div class="img-wrap bg-lighter"><img src="images/landing/landing-57-34x34.png" alt=""></div>
                        <div class="caption">RD Event Calendar</div>
                      </div>
              </div>
              <div class="col-sm-6 col-md-3 col-lg-2 col-xxl-1">
                      <div class="blurb-mini wow fadeInLeft" data-wow-delay="0.4s">
                        <div class="img-wrap bg-lighter"><img src="images/landing/landing-58-34x32.png" alt=""></div>
                        <div class="caption">Mail Form</div>
                      </div>
              </div>
              <div class="col-sm-6 col-md-3 col-lg-2 col-xxl-1">
                      <div class="blurb-mini wow fadeInLeft" data-wow-delay="0.2s">
                        <div class="img-wrap bg-lighter"><img src="images/landing/landing-56-38x38.png" alt=""></div>
                        <div class="caption">ReCaptcha</div>
                      </div>
              </div>
              <div class="col-sm-6 col-md-3 col-lg-2 col-xxl-1">
                      <div class="blurb-mini wow fadeInLeft">
                        <div class="img-wrap bg-lighter"><img src="images/landing/landing-54-37x40.png" alt=""></div>
                        <div class="caption">Mailchimp</div>
                      </div>
              </div>
              <div class="col-sm-6 col-md-3 col-lg-2 col-xxl-1">
                      <div class="blurb-mini wow fadeInRight">
                        <div class="img-wrap bg-lighter"><img src="images/landing/landing-61-35x23.png" alt=""></div>
                        <div class="caption">Campaign Monitor</div>
                      </div>
              </div>
              <div class="col-sm-6 col-md-3 col-lg-2 col-xxl-1">
                      <div class="blurb-mini wow fadeInRight" data-wow-delay="0.2s">
                        <div class="img-wrap bg-lighter"><img src="images/landing/landing-59-35x35.png" alt=""></div>
                        <div class="caption">4 Footer layouts</div>
                      </div>
              </div>
              <div class="col-sm-6 col-md-3 col-lg-2 col-xxl-1">
                      <div class="blurb-mini wow fadeInRight" data-wow-delay="0.4s">
                        <div class="img-wrap bg-lighter"><img src="images/landing/landing-60-35x32.png" alt=""></div>
                        <div class="caption">Charts and Graphs</div>
                      </div>
              </div>
              <div class="col-sm-6 col-md-3 col-lg-2 col-xxl-1">
                      <div class="blurb-mini wow fadeInRight" data-wow-delay="0.6s">
                        <div class="img-wrap bg-lighter"><img src="images/landing/landing-55-40x40.png" alt=""></div>
              ...
              <div class="col-sm-6 col-md-3 col-lg-2 col-xxl-1">
                      <div class="blurb-mini wow fadeInLeft" data-wow-delay="0.6s">
                        <div class="img-wrap bg-lighter"><img src="images/landing/landing-67-37x24.png" alt=""></div>
                        <div class="caption">26 Child Themes</div>
                      </div>
              </div>
              <div class="col-sm-6 col-md-3 col-lg-2 col-xxl-1">
                      <div class="blurb-mini wow fadeInLeft" data-wow-delay="0.4s">
                        <div class="img-wrap bg-lighter"><img src="images/landing/landing-68-30x30.png" alt=""></div>
                        <div class="caption">Search Form</div>
                      </div>
              </div>
              <div class="col-sm-6 col-md-3 col-lg-2 col-xxl-1">
                      <div class="blurb-mini wow fadeInLeft" data-wow-delay="0.2s">
                        <div class="img-wrap bg-lighter"><img src="images/landing/landing-63-34x34.png" alt=""></div>
                        <div class="caption">Gallery (Isotope) (Hover Effects)</div>
                      </div>
              </div>
              <div class="col-sm-6 col-md-3 col-lg-2 col-xxl-1">
                      <div class="blurb-mini wow fadeInLeft">
                        <div class="img-wrap bg-lighter"><img src="images/landing/landing-65-34x34.png" alt=""></div>
                        <div class="caption">Shop</div>
                      </div>
              </div>
              <div class="col-sm-6 col-md-3 col-lg-2 col-xxl-1">
                      <div class="blurb-mini wow fadeInRight">
                        <div class="img-wrap bg-lighter"><img src="images/landing/landing-62-38x38.png" alt=""></div>
                        <div class="caption">Google Fonts</div>
                      </div>
              </div>
              <div class="col-sm-6 col-md-3 col-lg-2 col-xxl-1">
                      <div class="blurb-mini wow fadeInRight" data-wow-delay="0.2s">
                        <div class="img-wrap bg-lighter"><img src="images/landing/landing-66-32x32.png" alt=""></div>
                        <div class="caption">Icon Fonts (FontAwesome, Material Design Icons)</div>
                      </div>
              </div>
              <div class="col-sm-6 col-md-3 col-lg-2 col-xxl-1">
                      <div class="blurb-mini wow fadeInRight" data-wow-delay="0.4s">
                        <div class="img-wrap bg-lighter"><img src="images/landing/landing-69-47x18.png" alt=""></div>
                        <div class="caption">Animate CSS, WOW Animation</div>
                      </div>
              </div>
              <div class="col-sm-6 col-md-3 col-lg-2 col-xxl-1">
                      <div class="blurb-mini wow fadeInRight" data-wow-delay="0.6s">
                        <div class="img-wrap bg-lighter"><img src="images/landing/landing-64-34x34.png" alt=""></div>
            ...
            <section class="section novi-background section-66 context-dark bg-acapulco">
              <div class="container">
                <div class="row justify-content-sm-center align-items-sm-center no-gutters grid-group-md">
                  ...
                  <div class="col-lg-4 col-xl-3"><a class="btn btn-icon btn-lg btn-default btn-anis-effect btn-icon-btn-icon-left" href="//documentation.zemez.io/html/bootstrap/intense/" target="_blank"><span class="icon novi-icon mdi mdi-cart-outline"></span>Buy intense now</a>
                  </div>
                </div>
              </div>
            </section>
      <!-- Core features-->
      <section class="section novi-background section-66 section-xl-124">
        <div class="container-fluid"><img src="images/landing/landing-105-154x25.png" alt>
          <div class="offset-top-10">
            <h2><span class="big">Our Customer Reviews</span></h2>
          </div>
          <div class="offset-top-24 d-none d-lg-block">
            <hr class="divider bg-mantis">
          </div>
          <div class="offset-top-20 offset-lg-top-34 offset-xxl-top-66">
            <div class="row justify-content-sm-center grid-group-sm" data-lightgallery="group">
              <div class="col-sm-12 wow fadeIn"><a class="review-wrap shadow-drop" data-lightgallery="item" href="images/landing/landing-98-1362x208.jpg" data-size="1362x208"><img src="images/landing/landing-98-1362x208.jpg" alt></a></div>
              <div class="col-sm-12 wow fadeIn"><a class="review-wrap shadow-drop" data-lightgallery="item" href="images/landing/landing-99-1362x187.jpg" data-size="1362x187"><img src="images/landing/landing-99-1362x187.jpg" alt></a></div>
              <div class="col-sm-12 wow fadeIn"><a class="review-wrap shadow-drop" data-lightgallery="item" href="images/landing/landing-100-1362x208.jpg" data-size="1362x208"><img src="images/landing/landing-100-1362x208.jpg" alt></a></div>
              <div class="col-sm-12 wow fadeIn"><a class="review-wrap shadow-drop" data-lightgallery="item" href="images/landing/landing-101-1362x187.jpg" data-size="1362x187"><img src="images/landing/landing-101-1362x187.jpg" alt></a></div>
              <div class="col-sm-12 wow fadeIn"><a class="review-wrap shadow-drop" data-lightgallery="item" href="images/landing/landing-102-1362x208.jpg" data-size="1362x208"><img src="images/landing/landing-102-1362x208.jpg" alt></a></div>
              <div class="col-sm-12 wow fadeIn"><a class="review-wrap shadow-drop" data-lightgallery="item" href="images/landing/landing-103-1362x183.jpg" data-size="1362x183"><img src="images/landing/landing-103-1362x183.jpg" alt></a></div>
            </div>
          </div>
        </div>
      </section>
      <!-- Features-->
      <section class="section novi-background section-66 section-xl-124 bg-lighter">
        <div class="container container-wide">
          <div class="d-none d-lg-block">
            <h2><span class="big">Features</span></h2>
          </div>
          <div class="offset-top-20 d-none d-lg-block">
            <hr class="divider bg-mantis">
          </div>
          <div class="offset-lg-top-20 offset-xxl-top-66">
            <h3 class="text-regular">Other Features<span class="text-uppercase text-ubold text-mantis"> Intense</span></h3>
          </div>
          <div class="offset-top-20 offset-xxl-top-50">
            <div class="owl-carousel owl-carousel-default owl-carousel-present owl-carousel-arrows veil-owl-nav veil-xxl-owl-dots reveal-xxl-owl-nav" data-items="1" data-md-items="2" data-lg-items="3" data-xl-items="4" data-nav="true" data-dots="true" data-autoplay="true" data-loop="true" data-sm-margin="30" data-nav-class="[&quot;owl-prev mdi mdi-chevron-left&quot;, &quot;owl-next mdi mdi-chevron-right&quot;]">
              <div class="offset-top-10 grid-group-md"><a class="thumbnail-simple" target="_blank" href="revolution-crossfade.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-70-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Revolution Slider - Crossfade</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
                        </div></a><a class="thumbnail-simple" target="_blank" href="revolution-slidingoverlayhorizontal.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-74-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Revolution Slider - Overlay 1</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
              ...
              <div class="offset-top-10 grid-group-md"><a class="thumbnail-simple" target="_blank" href="revolution-fadethrough.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-71-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Revolution Slider - Fade Through</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
                        </div></a><a class="thumbnail-simple" target="_blank" href="revolution-slidingoverlayvertical.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-75-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Revolution Slider - Overlay 2</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
              ...
              <div class="offset-top-10 grid-group-md"><a class="thumbnail-simple" target="_blank" href="revolution-slidehorizontal.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-72-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Revolution Slider - Slide 1</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
                        </div></a><a class="thumbnail-simple" target="_blank" href="revolution-boxslide.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-76-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Revolution Slider - Box Slide</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
              ...
              <div class="offset-top-10 grid-group-md"><a class="thumbnail-simple" target="_blank" href="revolution-slidevertical.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-73-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Revolution Slider - Slide 2</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
                        </div></a><a class="thumbnail-simple" target="_blank" href="revolution-slotslide.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-77-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Revolution Slider - Slot Slide</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
              ...
              <div class="offset-top-10 grid-group-md"><a class="thumbnail-simple" target="_blank" href="revolution-boxfade.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-78-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Revolution Slider - Box Fade</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
                        </div></a><a class="thumbnail-simple" target="_blank" href="revolution-slotzoom-horizontal.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-82-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Revolution Slider - Slot Zoom 1</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
              ...
              <div class="offset-top-10 grid-group-md"><a class="thumbnail-simple" target="_blank" href="revolution-slotfade.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-79-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Revolution Slider - Slot Fade</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
                        </div></a><a class="thumbnail-simple" target="_blank" href="revolution-slotzoom-vertical.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-83-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Revolution Slider - Slot Zoom 2</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
              ...
              <div class="offset-top-10 grid-group-md"><a class="thumbnail-simple" target="_blank" href="revolution-parallaxhorizontal.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-80-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Revolution Slider - Parallax 1</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
                        </div></a><a class="thumbnail-simple" target="_blank" href="revolution-incube.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-84-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Revolution Slider - In Cube</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
              ...
              <div class="offset-top-10 grid-group-md"><a class="thumbnail-simple" target="_blank" href="revolution-parallaxvertical.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-81-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Revolution Slider - Parallax 1</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
                        </div></a><a class="thumbnail-simple" target="_blank" href="rd-event-calendar.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-85-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">RD Event Calendar</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
              ...
              <div class="offset-top-10 grid-group-md"><a class="thumbnail-simple" target="_blank" href="rd-parallax.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-86-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Parallax</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
              ...
              <div class="offset-top-10 grid-group-md"><a class="thumbnail-simple" target="_blank" href="rd-video.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-87-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Vide</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
                        </div></a><a class="thumbnail-simple" target="_blank" href="rd-navbar.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-88-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">RD Navbar</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
              ...
              <div class="offset-top-10 grid-group-md"><a class="thumbnail-simple" target="_blank" href="rd-mailform.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-92-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Form Plugins</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
                        </div></a><a class="thumbnail-simple" target="_blank" href="rd-twitter-feed.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-89-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">RD Twitter Feed</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
              ...
              <div class="offset-top-10 grid-group-md"><a class="thumbnail-simple" target="_blank" href="captcha.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-93-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">google reCaptcha</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
                        </div></a><a class="thumbnail-simple" target="_blank" href="charts-and-graphs.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-94-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Charts and Graphs</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
              ...
              <div class="offset-top-10 grid-group-md"><a class="thumbnail-simple" target="_blank" href="ui-kit.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-95-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Advanced UI Kit</span>
                          </h4>
                        </div>
                        <div class="offset-xxl-top-14 d-none d-xxl-block">
                          <hr class="divider divider-xs bg-mantis">
                        </div></a><a class="thumbnail-simple" target="_blank" href="rd-parallax.html">
                        <div class="thumbnail-wrap"><img width="420" height="316" src="images/landing/landing-86-420x316.jpg" alt=""></div>
                        <div class="offset-top-14 offset-xxl-top-20">
                          <h4><span class="caption font-weight-bold text-middle">Parallax</span>
                          </h4>
      ...
      <section class="section novi-background section-66 section-xl-110">
        <div class="container-fluid">
          <h1>15+ <span class="text-red"> Revolution </span> Slider effects</h1>
          <div><img class="img-fluid d-block mx-auto wow fadeInUp" src="images/logos/slider.jpg" alt></div>
        </div>
      </section>
      <!-- Extremely Responsive and Retina-->
      <section class="section novi-background section-66 bg-lighter">
        <div class="container-fluid">
          <div class="row justify-content-sm-center grid-group-md">
            <div class="col-md-10 col-lg-6 col-xxl-7 d-md-block"><img class="img-fluid wow fadeInLeft d-md-inline-block" src="images/landing/landing-97-780x462.png" width="780" height="462" alt data-wow-delay="0.3s"></div>
            <div class="col-md-8 col-lg-6 col-xxl-4 text-lg-left offset-lg-top-41">
              <h1>Extremely Responsive <br class="d-none d-xl-block">and Retina</h1>
              <p>Create Your Own Business, Blog or any kind of activity Quick <br class="d-none d-xl-block">and Easy with our unbelievable already made niche templates.</p>
            </div>
          </div>
        </div>
      </section>
            <section class="section parallax-container context-dark" data-parallax-img="images/landing/landing-104-1920x1348.jpg">
              <div class="parallax-content section-66 section-xl-110">
                <div class="container">
                  ...
                  <div class="row justify-content-sm-center grid-group-sm offset-top-34 offset-lg-top-66">
                    <div class="col-sm-6 col-md-5 col-lg-4 col-xl-2 wow fadeInRight"><img class="img-fluid d-block mx-auto" src="images/features/home-intro-04-150x100.png" width="150" height="100" alt>
                      <p>Transparent</p>
                    </div>
                    <div class="col-sm-6 col-md-5 col-lg-4 col-xl-2 wow fadeInRight" data-wow-delay="0.1s"><img class="img-fluid d-block mx-auto" src="images/features/home-intro-05-150x100.png" width="150" height="100" alt>
                      <p>Background Header</p>
                    </div>
                    <div class="col-sm-6 col-md-5 col-lg-4 col-xl-2 wow fadeInRight" data-wow-delay="0.2s"><img class="img-fluid d-block mx-auto" src="images/features/home-intro-06-150x100.png" width="150" height="100" alt>
                      <p>Center Aligned</p>
                    </div>
                    <div class="col-sm-6 col-md-5 col-lg-4 col-xl-2 wow fadeInRight" data-wow-delay="0.3s"><img class="img-fluid d-block mx-auto" src="images/features/home-intro-07-150x100.png" width="150" height="100" alt>
                      <p>Floating</p>
                    </div>
                    <div class="col-sm-6 col-md-5 col-lg-4 col-xl-2 wow fadeInRight" data-wow-delay="0.4s"><img class="img-fluid d-block mx-auto" src="images/features/home-intro-08-150x100.png" width="150" height="100" alt>
                      <p>Left Side-Header</p>
                    </div>
                    <div class="col-sm-6 col-md-5 col-lg-4 col-xl-2 wow fadeInRight" data-wow-delay="0.5s"><img class="img-fluid d-block mx-auto" src="images/features/home-intro-09-150x100.png" width="150" height="100" alt>
      ...
      <!-- Portfolio Templates-->
      <section class="section novi-background section-top-66 section-xl-top-98">
        <div class="container-fluid">
          <div class="row justify-content-sm-center justify-content-xxl-end grid-group-md">
            <div class="col-md-8 col-xl-4 col-xxl-3">
              <div class="offset-xl-top-20 text-xl-left">
                <h1>Portfolio <br class="d-none d-xl-block">Templates</h1>
                <p>Showcase any of your products or projects with <br class="d-none d-xl-block">our great selection of Portfolio templates.</p>
              </div>
            </div>
      ...
      <!-- Blog Templates-->
      <section class="section novi-background section-66 section-lg-bottom-0 section-xl-top-110 context-dark bg-mantis">
        <div class="container-fluid">
          <div class="row justify-content-sm-center justify-content-xl-start">
            ...
            <div class="col-md-8 col-xl-4 col-xxl-3 text-xl-left">
      ...
      <!-- eCommerce Ready-->
      <section class="section novi-background section-top-66 section-xl-top-110">
        <div class="container-fluid">
          <div class="row justify-content-sm-center align-items-xl-end justify-content-xxl-end grid-group-md">
            <div class="col-md-8 col-xl-4 col-xxl-3 text-xl-left">
              <div class="section-lg-bottom-66">
                <h1>eCommerce Ready</h1>
                <p>We have included all you may need to build an <br class="d-none d-xl-block">Amazing eCommerce Website from a scratch. Create your successful business now!</p>
      ...
      <!-- Event Managing -->
      <section class="section novi-background section-66 section-lg-bottom-0 section-xl-top-85 bg-blue-gray context-dark">
        <div class="container-fluid">
          <div class="row justify-content-sm-center grid-group-md">
            <div class="col-md-6 col-xl-7 col-xxl-5">
              <div class="mock-up-4">
                <div class="object"><img class="wow fadeInUp" src="images/landing/landing-114-676x485.png" width="676" height="485" alt></div>
              </div>
            </div>
            <div class="col-md-8 col-xl-5 col-xxl-3 text-xl-left">
              <div class="inset-xxl-left-50 offset-xl-top-34">
      ...
      <!-- PSD Included-->
      <section class="section novi-background section-66 section-xl-110 bg-default" style="position: relative; z-index: 1; box-shadow: 0px -5px 23px 0 rgba(0, 0, 0, 0.15);">
        <div class="container-fluid">
      ...
      <!-- Demo Images Included for Free-->
            <section class="section parallax-container context-dark" data-parallax-img="images/features/home-intro-15-1920x592.jpg">
              <div class="parallax-content bg-overlay-gray-darkest section-98 section-lg-110 section-xl-254">
                <div class="container">
      ...
      <section class="section novi-background bg-default section-top-66 section-md-top-0">
        <div class="container-fluid text-lg-left">
          <div class="row justify-content-sm-center align-items-sm-end align-items-xl-start">
            <div class="col-lg-6 col-xxl-4">
              <div class="section-md-66 section-lg-top-124"><span class="novi-icon icon icon-lg linearicons-headset text-mantis"></span>
                <div class="offset-top-10 offset-lg-top-20">
            ...
            <div class="col-md-6 col-xxl-4"><img class="img-fluid" src="images/landing/landing-115-569x465.jpg" alt></div>
          </div>
        </div>
      </section>
      <!-- Buy Now-->
            <!-- Call to action type 2-->
            <section class="section novi-background section-66 context-dark bg-mantis">
              <div class="container">
                <div class="row justify-content-sm-center align-items-sm-center no-gutters grid-group-md">
                  <div class="col-lg-7 col-xxl-9 text-center text-lg-left">
                    <h2><span class="big">Intense is exactly what you need</span></h2>
      ...
      <!-- Home Intro footer-->
      <footer class="section novi-background section-34 page-footer bg-black context-dark">
        <div class="container">
          ...
          <p class="small text-darker">&copy; <span class="copyright-year"></span> . <a href="privacy.html">Privacy Policy</a></p>
        </div>
      </footer>
    </div>
